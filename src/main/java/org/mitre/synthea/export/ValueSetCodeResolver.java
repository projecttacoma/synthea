...
/**
 * This class knows how to search through all the Code values within a Person
 * object, generating random codes using the ValueSet URI if one has been
 * supplied.
 */
public class ValueSetCodeResolver {
    ...
    /**
     * Generates random codes in any coded fields that have specified a ValueSet
     * URI.
     * 
    ...
    private Object resolveMaybeCode(@Nullable Object object) {
        ...
        return object.getClass() == Code.class ? resolveCode((Code) object) : object;
    }
    ...
    private Code resolveCode(@Nullable Code code) {
        ...
        return code.valueSet != null ? RandomCodeGenerator.getCode(code.valueSet, person.seed, code) : code;
    }
